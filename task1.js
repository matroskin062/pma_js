...
/* 
  При сравнении разных типов, они приводятся к числу. 
  Так как массивы не имеют метода valueOf, вызывается метод toString, 
  который возвращает единственный елемент массива в виде строки 'x'.
  'x' == 'x' => true
*/
